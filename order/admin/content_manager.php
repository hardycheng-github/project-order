...
if (preg_match('/.gif/',$content_array[$ii]['file'])
	or
	preg_match('/.jpg/',$content_array[$ii]['file'])
	or
	preg_match('/.png/',$content_array[$ii]['file'])
	or
	preg_match('/.html/',$content_array[$ii]['file'])
	or
	preg_match('/.htm/',$content_array[$ii]['file'])
	or
	preg_match('/.txt/',$content_array[$ii]['file'])
	or
	preg_match('/.bmp/',$content_array[$ii]['file'])
	) {
?>
...
<?php if ($_GET['action']!='new_products_content' && $_GET['action']!='edit_products_content' ) { ?>
