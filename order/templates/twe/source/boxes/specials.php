...
$box_content='';
  ...
  $random_product_query = "select
    ...
    $box_content='<a href="' . twe_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product->fields["products_id"]) . '">' . twe_image(DIR_WS_THUMBNAIL_IMAGES . $random_product->fields['products_image'], $random_product->fields['products_name'], PRODUCT_IMAGE_THUMBNAIL_WIDTH, PRODUCT_IMAGE_THUMBNAIL_HEIGHT) . '</a><br><a href="' . twe_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product->fields['products_id']) . '">' . $random_product->fields['products_name'] . '</a><br>'.twe_get_products_price($random_product->fields['products_id'],$price_special=1,$quantity=1);
