...
/* -----------------------------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------------------------*/
	...
	if(isset($_REQUEST['outerFrame'])) $include_html = '/outerFrame.html';
  ...
  /*
  ///////// myEdit shopping_cart start
  $shopping_cart_bottom = true;
  
  require_once($root_file . 'shopping_cart.php');
  ///////// myEdit shopping_cart end
  */
  
  $smarty->assign('language', $_SESSION['language']);
  $smarty->assign('empty_cPath', !isset($_GET['cPath']));
  $smarty->caching = 0;
  
  $smarty->display(CURRENT_TEMPLATE . $include_html);
  $c_string='';
 ?>
