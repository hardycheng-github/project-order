...
<tr> 
<td class="row1">{L_SHOW_ONLINE}</td>
<td class="row2"> 
<input type="radio" name="show_online" value="1" {INDEX_SHOW_ONLINE_YES} />
{L_YES}&nbsp;&nbsp; 
<input type="radio" name="show_online" value="0" {INDEX_SHOW_ONLINE_NO} />
{L_NO}</td>
</tr>
<tr> 
