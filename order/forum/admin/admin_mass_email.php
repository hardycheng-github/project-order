...
if ( isset($HTTP_POST_VARS['submit']) )
{
	...
	$sql = ( $group_id != -1 ) ? "SELECT u.customers_email_address FROM " . USERS_TABLE . " u, " . USER_GROUP_TABLE . " ug WHERE ug.group_id = $group_id AND ug.user_pending <> " . TRUE . " AND u.customers_id = ug.customers_id" : "SELECT customers_email_address FROM " . USERS_TABLE;
