 ...
 * running dohtmlspecialchars() over the text contained between
...
function bbencode_second_pass_code($text, $uid, $bbcode_tpl)
{
	...
	// First, do all the 1st-level matches. These need an dohtmlspecialchars() run,
 ...
 * dohtmlspecialchars().
 */
function undo_dohtmlspecialchars($input)
{
