...
// Get user list
//
$sql = "SELECT u.customers_id, u.username, u.user_allow_viewonline, u.user_level, s.session_logged_in, s.session_time, s.session_page, s.session_ip
...
while ( $row = $db->sql_fetchrow($result) )
{
	...
	if ( $view_online )
	{
		...
		$template->assign_block_vars("$which_row", array(
			...
			'U_USER_PROFILE' => append_sid("profile.$phpEx?mode=viewprofile&amp;" . POST_USERS_URL . '=' . $customers_id),
