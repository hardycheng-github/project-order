 ...
 *     by                   : 小竹子, OOHOO, 皇家騎士, 思
 *     email                : admin.phpbbtw@msa.hinet.net
 *                            webdev@phpbb-tw.net
...
$lang['Inst_Stwe_0'] = '感謝您選擇 phpBB 2 討論區系統. 您必須填寫下列資料以完成安裝程序. 在安裝前, 請先確定您所要使用的資料庫已經建立.';
...
$lang['Inst_Stwe_2'] = '您的系統管理員帳號已被建立, 討論區的基本安裝已經完成, 稍後 您將被指引至討論區的管理頁面.  請確認您已檢查基本組態的設定並做適當的修改. 再一次感謝您選擇使用 phpBB 2 討論區.';
...
$lang['Install'] = '完整安裝';
$lang['Upgrade'] = '系統升級';
$lang['show_online'] = '顯示討論區誰在線上'; 
$lang['show_online_explain'] = '顯示討論區誰在線上';
...
$lang['Version_not_up_to_date'] = '針對您目前所使用的版本 <b>系統強烈建議</b> 您立即更新，因為已經釋出最新安全性修正版本了！ 如果您要更新您的 phpBB 版本, 請造訪 phpBB 官方下載點 <a href="http://www.phpbb.com/downloads.php" target="_new">http://www.phpbb.com/downloads.php</a> 取得最新版的相關資訊,或是造訪竹貓星球 <a href="http://phpbb-tw.net/" target="_new">http://phpbb-tw.net/</a> 取得相關更新訊息.';
...
$lang['Mailing_list_subscribe_reminder'] = '想知道關於 phpBB 的最新資訊嗎？ 快加入我們的 <a href="http://www.phpbb.com/support/" target="_new">電子報發送清單吧！</a>.';
